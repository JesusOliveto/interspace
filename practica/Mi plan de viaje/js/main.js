...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const ciudadPredeterminada = $nombreCiudad.value; // Valor predeterminado de la ciudad
  const paisPredeterminado = $nombrePais.value; // Valor predeterminado del país

  callApi(paisPredeterminado, ciudadPredeterminada);
});
