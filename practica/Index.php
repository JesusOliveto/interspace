        ...
        <ul>
               <li class="submenu">
                    <img src="Imagenes\cart.png" id="cart-btn">
                        <div id="carrito" form method="post" action="MisCompras.php">   
                            <table id="lista-carrito" class="u-full-width">
                                <thead>
                                    <tr>
                                        <a>Imagen</a>
                                        <a id="nombrepaquete" class="input" type="text" placeholder="Nombre" name="nombrepaquete">Nombre</a>
                                        <a id="precio" name="precio" class="input" type="number" placeholder="Precio">Precio</a>
                                        <a id="pasaj" name="pasaj" class="input" type="number">Cantidad</a>
                                        <a></a>
                                    </tr>
                                </thead>
                                <tbody></tbody>
                            ...
                            <a href="MisCompras.php" id="compra" class="comprar u-full-width">Comprar</a>
